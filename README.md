...
- **Strain catalog:** 370+ built-in strains across multiple breeders and clone
  providers, including the Hawaiian heritage landraces, with autocomplete on
...
- **Terpene profiles** plus a **KNF ferment tracker** (log FPJ/FAA/LAB batches & timing)
- **Companion planting guide** plus a **nutrient-availability pH chart**
- **Unit converter** plus **harvest forecast** (projected dates & yields)
...
- Keep changes vanilla JS, with no new dependencies or build tooling.
